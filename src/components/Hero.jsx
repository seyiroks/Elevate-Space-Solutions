        ...
        <div className="w-full px-6 md:px-12 lg:px-20 xl:px-32">
          <div className="max-w-4xl mx-auto md:mx-0 text-center md:text-left text-white mt-8 md:mt-24">
            ...
            <p
              ...
              style={{ textShadow: "0 6px 25px rgba(0,0,0,0.6)" }}
            >
              Professional cleaning, interior repairs, <br className="hidden sm:block" />
            ...
            <div className="flex flex-col items-center md:items-start gap-4 sm:gap-6 md:gap-10">
              <button className="w-[220px] bg-primary text-white px-8 py-3 rounded-lg shadow-md hover:translate-y-[2px] hover:shadow-sm transition">
                Get a Free Quote
              </button>
